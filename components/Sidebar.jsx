    ...
    return (
        <div className="h-full hidden  sm:flex flex-col fixed xl:ml-24">
            ...
            <div className="flex justify-center items-center xl:justify-start py-3 xl:p-3">
                ...
                <img className="w-10 h-10 rounded-full object-cover" src={user.photoUrl || "/assets/blankpfp.png" } />
...
function SidebarLink({text, Icon}){
   return( <li className="hoverAnimation flex mb-3 xl:justify-start justify-center items-center text-xl space-x-3">
        <Icon className="h-7"/>
