    ...
    return(
       <div className="hidden lg:flex flex-col ml-7 mt-4">
        ...
        <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
            ...
            <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
                <p className="text-xs text-gray-500">Trending in US</p>
                <h1 className="text-[15px] font-bold">Europe</h1>
                <p className="text-xs text-gray-500">430K Tweets</p>
            </div>
            ...
            <div className="flex justify-between p-3">
                <div className="flex space-x-3">
                    ...
                    <div className="flex space-x-1">
                        <h1 className="font-bold">Buzz Lightyear</h1>
                        <BadgeCheckIcon className="w-[18px] text-blue-400" />
                    </div>
                    <h1 className="text-[12px] text-gray-500 mt-1">@Buzzlightyear</h1>
                    </div>
                </div>
                <button className="bg-white text-black text-sm w-20 h-8 rounded-3xl font-bold hover:bg-blue-400 hover:text-white">
                    Follow
                </button>
            </div>
            <div className="flex justify-between p-3">
